...
@section('page-subtitle', 'Create and publish a news article')
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" required
                       x-on:input="slug.value = $el.value.toLowerCase().replace(/[^a-z0-9]+/g,'-').replace(/^-|-$/g,'')"
            ...
            <div>
                ...
                <textarea name="excerpt" rows="2" required maxlength="500"
                          class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500 focus:outline-none resize-none @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
            ...
            <div>
                ...
                <textarea name="body" rows="12" required
                          class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500 focus:outline-none @error('body') border-red-500 @enderror">{{ old('body') }}</textarea>
