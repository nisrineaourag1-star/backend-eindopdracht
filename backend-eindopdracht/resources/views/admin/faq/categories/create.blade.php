...
@section('title', 'New FAQ Category')
@section('page-title', 'New FAQ Category')
@section('page-subtitle', 'Create a new FAQ category group')

@section('content')

    <form method="POST" action="{{ route('admin.faq-categories.store') }}" class="max-w-lg space-y-6">
        @csrf
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5">
            ...
            <div>
                <label class="block text-gray-400 text-sm font-medium mb-1.5">Slug <span class="text-gray-600 font-normal">(optional — auto-generated)</span></label>
